...
public class LocomotionSampleSupport : MonoBehaviour
{
    ...
    */
    ...
    void SetupWalkOnly()
    {
        // Disable the teleport controller
        TeleportController.enabled = false;

        // Enable linear movement in the player controller
        lc.PlayerController.EnableLinearMovement = true;

        // You can set other player controller settings here if needed
        // For example, enable snap rotation if required:
        // lc.PlayerController.SnapRotation = true;
    
        // Ensure that rotation is controlled by the thumbstick
        lc.PlayerController.RotationEitherThumbstick = false;

        // You can set the speed steps for rotation if needed:
        // lc.PlayerController.FixedSpeedSteps = 1;
    }
